...
export const useUpdatePostStatusChangeMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UpdatePostStatusChangeMutation, TError, UpdatePostStatusChangeMutationVariables, TContext>) => {
    
    return useMutation<UpdatePostStatusChangeMutation, TError, UpdatePostStatusChangeMutationVariables, TContext>(
      {
    mutationKey: ['UpdatePostStatusChange'],
    mutationFn: (variables?: UpdatePostStatusChangeMutationVariables) => graphqlFetch<UpdatePostStatusChangeMutation, UpdatePostStatusChangeMutationVariables>(UpdatePostStatusChangeDocument, variables)(),
    ...options
  }
    )};

useUpdatePostStatusChangeMutation.getKey = () => ['UpdatePostStatusChange'];
