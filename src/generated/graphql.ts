 ...
 * )
 */
export const mockCreatePostMutation = (resolver: GraphQLResponseResolver<CreatePostMutation, CreatePostMutationVariables>, options?: RequestHandlerOptions) =>
 ...
 * )
 */
export const mockDeletePostMutation = (resolver: GraphQLResponseResolver<DeletePostMutation, DeletePostMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<DeletePostMutation, DeletePostMutationVariables>(
    'DeletePost',
    resolver,
    options
  )
 ...
 * )
 */
export const mockDeleteUpvoteMutation = (resolver: GraphQLResponseResolver<DeleteUpvoteMutation, DeleteUpvoteMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<DeleteUpvoteMutation, DeleteUpvoteMutationVariables>(
    'DeleteUpvote',
    resolver,
    options
  )
 ...
 * )
 */
export const mockUpvotePostMutation = (resolver: GraphQLResponseResolver<UpvotePostMutation, UpvotePostMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<UpvotePostMutation, UpvotePostMutationVariables>(
    'UpvotePost',
    resolver,
    options
  )
 ...
 * )
 */
export const mockDashboardAggregatesQuery = (resolver: GraphQLResponseResolver<DashboardAggregatesQuery, DashboardAggregatesQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<DashboardAggregatesQuery, DashboardAggregatesQueryVariables>(
    'DashboardAggregates',
    resolver,
    options
  )
 ...
 * )
 */
export const mockOrganizationQuery = (resolver: GraphQLResponseResolver<OrganizationQuery, OrganizationQueryVariables>, options?: RequestHandlerOptions) =>
 ...
 * )
 */
export const mockOrganizationMetricsQuery = (resolver: GraphQLResponseResolver<OrganizationMetricsQuery, OrganizationMetricsQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<OrganizationMetricsQuery, OrganizationMetricsQueryVariables>(
    'OrganizationMetrics',
    resolver,
    options
  )
 ...
 *   ({ query, variables }) => {
 *     const { first, orderBy, userId, search } = variables;
 *     return HttpResponse.json({
 *       data: { organizations }
 *     })
 *   },
 ...
 * )
 */
export const mockOrganizationsQuery = (resolver: GraphQLResponseResolver<OrganizationsQuery, OrganizationsQueryVariables>, options?: RequestHandlerOptions) =>
 ...
 * )
 */
export const mockPostsQuery = (resolver: GraphQLResponseResolver<PostsQuery, PostsQueryVariables>, options?: RequestHandlerOptions) =>
 ...
 * )
 */
export const mockProjectQuery = (resolver: GraphQLResponseResolver<ProjectQuery, ProjectQueryVariables>, options?: RequestHandlerOptions) =>
 ...
 * )
 */
export const mockProjectsQuery = (resolver: GraphQLResponseResolver<ProjectsQuery, ProjectsQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<ProjectsQuery, ProjectsQueryVariables>(
    'Projects',
    resolver,
    options
  )
 ...
 * )
 */
export const mockRecentFeedbackQuery = (resolver: GraphQLResponseResolver<RecentFeedbackQuery, RecentFeedbackQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<RecentFeedbackQuery, RecentFeedbackQueryVariables>(
    'RecentFeedback',
    resolver,
    options
  )
 ...
 * )
 */
export const mockWeeklyFeedbackQuery = (resolver: GraphQLResponseResolver<WeeklyFeedbackQuery, WeeklyFeedbackQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<WeeklyFeedbackQuery, WeeklyFeedbackQueryVariables>(
    'WeeklyFeedback',
    resolver,
    options
  )
