 ...
 * )
 */
export const mockDefaultStatusQuery = (resolver: GraphQLResponseResolver<Types.DefaultStatusQuery, Types.DefaultStatusQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.DefaultStatusQuery, Types.DefaultStatusQueryVariables>(
    'DefaultStatus',
    resolver,
    options
  )
