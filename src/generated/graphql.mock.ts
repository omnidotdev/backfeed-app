 ...
 * )
 */
export const mockCreateAttachmentMutation = (resolver: GraphQLResponseResolver<Types.CreateAttachmentMutation, Types.CreateAttachmentMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.CreateAttachmentMutation, Types.CreateAttachmentMutationVariables>(
    'CreateAttachment',
    resolver,
    options
  )
 ...
 * )
 */
export const mockDeleteAttachmentMutation = (resolver: GraphQLResponseResolver<Types.DeleteAttachmentMutation, Types.DeleteAttachmentMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.DeleteAttachmentMutation, Types.DeleteAttachmentMutationVariables>(
    'DeleteAttachment',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockMarkAllNotificationsReadMutation(
 *   ({ query, variables }) => {
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockMarkAllNotificationsReadMutation = (resolver: GraphQLResponseResolver<Types.MarkAllNotificationsReadMutation, Types.MarkAllNotificationsReadMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.MarkAllNotificationsReadMutation, Types.MarkAllNotificationsReadMutationVariables>(
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockMarkNotificationsReadMutation(
 *   ({ query, variables }) => {
 *     const { ids } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockMarkNotificationsReadMutation = (resolver: GraphQLResponseResolver<Types.MarkNotificationsReadMutation, Types.MarkNotificationsReadMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.MarkNotificationsReadMutation, Types.MarkNotificationsReadMutationVariables>(
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockChangePostStatusMutation(
 *   ({ query, variables }) => {
 *     const { postId, statusTemplateId, note } = variables;
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockChangePostStatusMutation = (resolver: GraphQLResponseResolver<Types.ChangePostStatusMutation, Types.ChangePostStatusMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.ChangePostStatusMutation, Types.ChangePostStatusMutationVariables>(
    'ChangePostStatus',
    resolver,
    options
  )
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockDeletePostStatusChangeMutation(
 *   ({ query, variables }) => {
 *     const { rowId } = variables;
 *     return HttpResponse.json({
 *       data: { deletePostStatusChange }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockDeletePostStatusChangeMutation = (resolver: GraphQLResponseResolver<Types.DeletePostStatusChangeMutation, Types.DeletePostStatusChangeMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.DeletePostStatusChangeMutation, Types.DeletePostStatusChangeMutationVariables>(
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockUpdatePostStatusChangeMutation(
 *   ({ query, variables }) => {
 *     const { rowId, note } = variables;
 *     return HttpResponse.json({
 *       data: { updatePostStatusChange }
 *     })
 *   },
 *   requestOptions
 * )
 */
export const mockUpdatePostStatusChangeMutation = (resolver: GraphQLResponseResolver<Types.UpdatePostStatusChangeMutation, Types.UpdatePostStatusChangeMutationVariables>, options?: RequestHandlerOptions) =>
  graphql.mutation<Types.UpdatePostStatusChangeMutation, Types.UpdatePostStatusChangeMutationVariables>(
 ...
 * mockProjectQuery(
 *   ({ query, variables }) => {
 *     const { projectSlug, organizationId, userId } = variables;
 *     return HttpResponse.json({
 *       data: { projects }
 *     })
 *   },
 ...
 *   ({ query, variables }) => {
 *     const { organizationIds, after } = variables;
 *     return HttpResponse.json({
 *       data: { posts }
 *     })
 *   },
 ...
 * @see https://mswjs.io/docs/basics/response-resolver
 * @example
 * mockUnreadNotificationCountQuery(
 *   ({ query, variables }) => {
 *     return HttpResponse.json({
 ...
 * )
 */
export const mockUnreadNotificationCountQuery = (resolver: GraphQLResponseResolver<Types.UnreadNotificationCountQuery, Types.UnreadNotificationCountQueryVariables>, options?: RequestHandlerOptions) =>
  graphql.query<Types.UnreadNotificationCountQuery, Types.UnreadNotificationCountQueryVariables>(
