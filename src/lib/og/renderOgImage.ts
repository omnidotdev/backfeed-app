...
const resolveLogoPath = (): string => {
  const candidates = [
    ...
    join(process.cwd(), ".output", "public", "img", "logo.png"),
  ];
 ...
 * individual feedback share previews. Pass an optional `eyebrow` (e.g. a status
  ...
  const svg = await satori(
    {
      ...
      props: {
        ...
        children: [
            ...
            props: {
              ...
              children: [
                ...
                },
                {
                  type: "span",
                  props: {
                    style: { fontSize: "28px", color: "#1a1a1a", opacity: 0.9 },
                    children: "Omni",
                  },
                },
              ],
          ...
          // Bottom: Backfeed logo + name + workspace + domain
          {
            type: "div",
            props: {
              style: {
